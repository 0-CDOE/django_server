...
class AnswerCreateView(LoginRequiredMixin, ExtraContextMixin, CreateView):
    """
    답변 생성 뷰.
...
class AnswerUpdateView(LoginRequiredMixin, ExtraContextMixin, UpdateView):
    """
    답변 수정 뷰.
    로그인한 사용자만 접근할 수 있으며, AnswerFormMixin을 사용하여 폼 처리를 한다.
...
def create_initial_ai_answer(post_id, selected_detectors, selected_predictors):
    """
